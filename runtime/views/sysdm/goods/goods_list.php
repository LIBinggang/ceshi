...
<head>
    ...
    <script type="text/javascript" charset="UTF-8" src="/iwebshop570303/runtime/_systemjs/jquery/jquery-1.12.4.min.js"></script> <script type="text/javascript" charset="UTF-8" src="/iwebshop570303/runtime/_systemjs/artdialog/artDialog.js?v=20190606"></script><script type="text/javascript" charset="UTF-8" src="/iwebshop570303/runtime/_systemjs/artdialog/plugins/iframeTools.js"></script><link rel="stylesheet" type="text/css" href="/iwebshop570303/runtime/_systemjs/artdialog/skins/black.css" /> <script type="text/javascript" charset="UTF-8" src="/iwebshop570303/runtime/_systemjs/form/form.js"></script> <script type="text/javascript" charset="UTF-8" src="/iwebshop570303/runtime/_systemjs/autovalidate/validate.js?v=20190606"></script><link rel="stylesheet" type="text/css" href="/iwebshop570303/runtime/_systemjs/autovalidate/style.css" /> <script type="text/javascript" charset="UTF-8" src="/iwebshop570303/runtime/_systemjs/artTemplate/artTemplate.js"></script><script type="text/javascript" charset="UTF-8" src="/iwebshop570303/runtime/_systemjs/artTemplate/artTemplate-plugin.js"></script> <script type="text/javascript" charset="UTF-8" src="/iwebshop570303/runtime/_systemjs/cookie/jquery.cookie.js"></script>
...
<body class="skin-blue fixed sidebar-mini" style="height: auto; min-height: 100%;">
    <div class="wrapper" style="height: auto; min-height: 100%;">
        ...
        <div id="admin_right" class="content-wrapper">
            <script type="text/javascript" charset="UTF-8" src="/iwebshop570303/runtime/_systemjs/artTemplate/artTemplate.js"></script><script type="text/javascript" charset="UTF-8" src="/iwebshop570303/runtime/_systemjs/artTemplate/artTemplate-plugin.js"></script>
...
<div class="content">
	<table class="table list-table">
		...
		<caption>
			 <div class="btn-group">
                <a href="<?php echo IUrl::creatUrl("/goods/goods_edit");?>" class="btn btn-default"><i class="fa fa-plus"></i> 添加</a>
                <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                    <span class="caret"></span>
                    <span class="sr-only"></span>
                </button>
                <ul class="dropdown-menu" role="menu">
                    <li><a href="<?php echo IUrl::creatUrl("/goods/goods_edit");?>">普通商品</a></li>
                    <li><a href="<?php echo IUrl::creatUrl("/goods/goods_edit/type/code");?>">服务类商品</a></li>
                    <li><a href="<?php echo IUrl::creatUrl("/goods/goods_edit/type/download");?>">下载类商品</a></li>
                    <li><a href="<?php echo IUrl::creatUrl("/goods/goods_edit/type/preorder");?>">时间类商品</a></li>
                </ul>
            </div>
			...
			<div class="btn-group">
				...
				<ul class="dropdown-menu" role="menu">
					<li><a href="javascript:void(0);" onclick="delModel({'name':'id[]','link':'<?php echo IUrl::creatUrl("/goods/goods_stats/type/up");?>','form':'goodsForm','msg':'选择商品上架？'});">上架</a></li>
					<li><a href="javascript:void(0);" onclick="delModel({'name':'id[]','link':'<?php echo IUrl::creatUrl("/goods/goods_stats/type/down");?>','form':'goodsForm','msg':'选择商品下架？'});">下架</a></li>
					<li><a href="javascript:void(0);" onclick="delModel({'name':'id[]','link':'<?php echo IUrl::creatUrl("/goods/goods_stats/type/check");?>','form':'goodsForm','msg':'选择商品待审？'});">待审</a></li>
					<li><a href="javascript:void(0);" onclick="delModel({'name':'id[]','link':'<?php echo IUrl::creatUrl("/goods/goods_del");?>','form':'goodsForm'})">删除</a></li>
					<li class="divider"></li>
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<img src='<?php echo IUrl::creatUrl("/pic/thumb/img/".$item['img']."/w/70/h/70");?>' class='pull-left img-thumbnail' />
				...
				<td>
					<a href="<?php echo IUrl::creatUrl("/goods/goods_edit/id/".$item['id']."/type/".$item['type']."");?>"><i class='operator fa fa-edit'></i></a>

					<?php if($item['type'] == 'preorder'){?>
					<a href='javascript:editPreorder(<?php echo isset($item['id'])?$item['id']:"";?>,<?php echo $item['spec_array'] ? 1 : 0;?>);'><i class='operator fa fa-calendar'></i></a>
					<?php }?>
...
function editPreorder(id,typeVal)
{
    switch(typeVal)
    {
        ...
        case 1:
        {
            var urlVal = "<?php echo IUrl::creatUrl("/block/products_list/goods_id/@id@");?>";
	...
	var urlVal = "<?php echo IUrl::creatUrl("/goods/preorder_setting/id/@id@/type/@type@");?>";
...
<script type='text/javascript'>
//图标配置
var icoConfig = {"商品管理":"fa-inbox","商品分类":"fa-list","品牌":"fa-registered","模型":"fa-cubes","搜索":"fa-search","会员管理":"fa-user-o","商户管理":"fa-group","信息处理":"fa-comment-o","订单管理":"fa-file-text","单据管理":"fa-files-o","发货地址":"fa-address-card-o","促销活动":"fa-bullhorn","营销活动":"fa-bell-o","优惠券管理":"fa-ticket","基础数据统计":"fa-bar-chart-o","后台首页":"fa-home","日志操作记录":"fa-file-code-o","商户数据统计":"fa-pie-chart","支付管理":"fa-credit-card","第三方平台":"fa-share-alt","配送管理":"fa-truck","地域管理":"fa-street-view","权限管理":"fa-unlock-alt","数据库管理":"fa-database","文章管理":"fa-file-o","帮助管理":"fa-question-circle-o","广告管理":"fa-flag","公告管理":"fa-bookmark-o","网站地图":"fa-sitemap","插件管理":"fa-cogs","网站管理":"fa-wrench","专题管理":"fa-magic"};
