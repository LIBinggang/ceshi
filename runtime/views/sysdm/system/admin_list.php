...
<div class="content">
	...
	<table class="table list-table">
		...
		<caption>
            <a class="btn btn-default" href='<?php echo IUrl::creatUrl("/system/admin_edit");?>'>
            ...
            <a class="btn btn-default" href='<?php echo IUrl::creatUrl("/system/admin_recycle");?>'>
		...
		<tbody>
            <?php $queryObj=Api::run('getListByAdmin',array('is_del'=>'0'));$resultData=$queryObj->find()?>
			...
			<tr>
				...
				<td>
					<a href='<?php echo IUrl::creatUrl("/system/admin_edit/id/".$item['id']."");?>'><i class='operator fa fa-edit'></i></a>
					<a href="javascript:void(0);" onclick="delModel({link:'<?php echo IUrl::creatUrl("/system/admin_update/recycle/del/id/".$item['id']."");?>',msg:'是否把信息放到回收站内？'});"><i class='operator fa fa-close'></i></a>
				</td>
			</tr>
			<?php }?>
		</tbody>
