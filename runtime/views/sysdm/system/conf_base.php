...
<head>
    ...
    <script type="text/javascript" charset="UTF-8" src="/iWebShop5.7.0303/runtime/_systemjs/jquery/jquery-1.12.4.min.js"></script> <script type="text/javascript" charset="UTF-8" src="/iWebShop5.7.0303/runtime/_systemjs/artdialog/artDialog.js?v=20190606"></script><script type="text/javascript" charset="UTF-8" src="/iWebShop5.7.0303/runtime/_systemjs/artdialog/plugins/iframeTools.js"></script><link rel="stylesheet" type="text/css" href="/iWebShop5.7.0303/runtime/_systemjs/artdialog/skins/black.css" /> <script type="text/javascript" charset="UTF-8" src="/iWebShop5.7.0303/runtime/_systemjs/form/form.js"></script> <script type="text/javascript" charset="UTF-8" src="/iWebShop5.7.0303/runtime/_systemjs/autovalidate/validate.js?v=20190606"></script><link rel="stylesheet" type="text/css" href="/iWebShop5.7.0303/runtime/_systemjs/autovalidate/style.css" /> <script type="text/javascript" charset="UTF-8" src="/iWebShop5.7.0303/runtime/_systemjs/artTemplate/artTemplate.js"></script><script type="text/javascript" charset="UTF-8" src="/iWebShop5.7.0303/runtime/_systemjs/artTemplate/artTemplate-plugin.js"></script> <script type="text/javascript" charset="UTF-8" src="/iWebShop5.7.0303/runtime/_systemjs/cookie/jquery.cookie.js"></script>
...
<body class="skin-blue fixed sidebar-mini" style="height: auto; min-height: 100%;">
    <div class="wrapper" style="height: auto; min-height: 100%;">
        ...
        <div id="admin_right" class="content-wrapper">
            <script type="text/javascript" charset="UTF-8" src="/iWebShop5.7.0303/runtime/_systemjs/editor/kindeditor-min.js"></script><script type="text/javascript">window.KindEditor.options.uploadJson = "/iWebShop5.7.0303/index.php?controller=pic&action=upload_json";</script>
<script type="text/javascript" charset="UTF-8" src="/iWebShop5.7.0303/runtime/_systemjs/artTemplate/artTemplate.js"></script><script type="text/javascript" charset="UTF-8" src="/iWebShop5.7.0303/runtime/_systemjs/artTemplate/artTemplate-plugin.js"></script>
				...
				<table class="table form-table">
					...
					<tr>
						...
						<td>
							...
							<img src="<?php echo IUrl::creatUrl("")."".$this->_siteConfig->logo."";?>" style="width:220px;" class='img-thumbnail' />
							<?php }?>
				...
				<table class="table form-table">
					...
					<tr>
						...
						<td>
                            <div class="input-group col-md-3">
                                <input type='text' name='tax' class='form-control' empty pattern='float' alt='请输入正确的整数或者浮点数' />
                                <span class="input-group-addon">%</span>
                            </div>
						    <p class="help-block">当买家需要发票的时候就要增加<商品金额>*<税率>的费用</p>
						</td>
					</tr>
					<tr>
						<th>商家的商品手续费：</th>
						<td>
                            <div class="input-group col-md-3">
                                <input type='text' name='commission' class='form-control' empty pattern='float' alt='请输入正确的整数或者浮点数' />
                                <span class="input-group-addon">%</span>
                            </div>
						    <p class="help-block">默认商家销售商品后需要给商城平台缴纳的手续费</p>
						</td>
					</tr>
					<tr>
						<th>默认备货时间：</th>
						<td>
						    <div class="input-group col-md-3">
						        <input type='text' class='form-control' name='stockup_time' pattern='int' alt='请填写整数' />
						        <span class="input-group-addon">天</span>
						    </div>
						    <p class="help-block">* 订单确认后需要备货的时间</p>
						</td>
					</tr>
					<tr>
						<th>新用户注册设置：</th>
					...
					<tr>
						...
						<td>
						    <div class="row">
    						    <div class="col-md-3">
    							    <input type='text' class='form-control' name='store_num_warning' pattern='int' alt='请填写整数' />
    						    </div>
						    </div>
						    <p class="help-block">当商品数量少于X件时，会在系统后台首页<a href="<?php echo IUrl::creatUrl("/system/default");?>"><库存预警></a>显示</p>
						</td>
					</tr>
					<tr>
						<th>用户提现额度：</th>
						<td>
							<div class="input-group col-md-3">
								<input type='text' name='low_withdraw' class='form-control' pattern='float' alt='请输入正确的整数或者浮点数' value="0"/>
								<span class="input-group-addon">￥</span>
							</div>
							<p class="help-block">用户提现申请的最低金额</p>
						</td>
					</tr>
					<tr>
						<th>商家货款时限：</th>
						<td>
						    <div class="input-group col-md-3">
						        <input type='text' class='form-control' name='low_bill' pattern='int' alt='请填写整数' value="0"/>
						        <span class="input-group-addon">天</span>
						    </div>
						    <p class="help-block">商家进行货款结算申请，在订单完成后且经过X天后，才可以进行申请</p>
						</td>
					</tr>
					<tr>
						<th></th>
			...
			<div class="tab-pane" id="tab5">
				...
				<table class="table form-table">
					...
					<tr>
						<th>API账号和密钥：</th>
						<td>
						    <p><input type='text' name='api_account' class='form-control' empty placeholder="API账号信息" /></p>
						    <p><input type='text' name='api_key' class='form-control' empty placeholder="API密钥信息" /></p>
						    <p class="help-block">付费购买云服务 <a href="http://www.aircheng.com/buy#other" target="_blank">点击价格表</a></p>
						</td>
					</tr>
