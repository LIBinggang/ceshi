		...
		<caption>
			...
			<div class="btn-group">
				...
				<ul class="dropdown-menu" role="menu">
					...
					<li><a href="javascript:void(0);" onclick="delModel({'form':'orderForm','name':'id[]','msg':'发货和打印选择的订单数据？','link':'<?php echo IUrl::creatUrl("/order/expresswaybill_template");?>'});">批量发货和打印快递单</a></li>
					<li class="divider"></li>
			...
			<a href="javascript:void(art.dialog.open('<?php echo IUrl::creatUrl("/order/order_code_check");?>',{title:'验证码核销',id:'order_code_check'}));" class="btn btn-default">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					...
					<a href="<?php echo IUrl::creatUrl("/order/expresswaybill_template/id/".$item['id']."");?>" target="_blank"><span class="badge bg-blue" title="发货和快递单打印">递</span></a>
				</td>
