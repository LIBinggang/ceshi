...
<body class="skin-blue fixed sidebar-mini" style="height: auto; min-height: 100%;">
    <div class="wrapper" style="height: auto; min-height: 100%;">
        ...
        <div id="admin_right" class="content-wrapper">
            <script type="text/javascript" charset="UTF-8" src="/iwebshop570303/runtime/_systemjs/my97date/wdatepicker.js"></script>
...
<div class="content">
	<table class="table list-table">
		...
		<caption class="row">
			<form action="<?php echo IUrl::creatUrl("/");?>" method="get" name="searchForm" class="form-inline col-sm-8">
			...
			<form action="<?php echo IUrl::creatUrl("/market/clear_log/type/account");?>" method="post" name='clear_log' class="form-inline col-sm-4">
		...
		<tbody>
			...
			<tr>
				...
				<td><?php echo AccountLog::eventText($item['event']);?></td>
